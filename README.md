...
8. To preview the final version of your project online, commit the project to your GitHub account. Access the index page at. `https://github.com/path/to/project/index.html` Copy that URL into [https://htmlpreview.github.io/](https://htmlpreview.github.io/)
